public class java_modevent_jsp implements com.sun.grid.cull.template.Template {
  public void print(final com.sun.grid.cull.Printer p, final java.util.Map params) {
    ...
    p.println("/**");
    p.println(" *  Generated from java_modevent.jsp");
...
p.println("");
    ...
    p.println("");
    p.println("import com.sun.grid.jgdi.event.ModEvent;");
    p.print("");
    ...
    p.print(name);p.println("ModEvent extends ModEvent implements java.io.Serializable {");
    p.println("");
    p.print("");
     // Default constructor ----------------------------------------- p.println("");
    p.print("  public ");
    p.print(name);p.println("ModEvent(long timestamp, int eventID) {");
...
} // end of class java_modevent_jsp
