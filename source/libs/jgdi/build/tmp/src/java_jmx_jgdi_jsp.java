public class java_jmx_jgdi_jsp implements com.sun.grid.cull.template.Template {
...
p.println("");
    p.println("");
    p.println("/**");
    p.println(" *   JGDIMBean interface of {@link com.sun.grid.jgdi.JGDI} for a JMX service.");
    p.println(" *   Defines all methods as {@link com.sun.grid.jgdi.JGDI}, but throws a");
    p.println(" */");
    p.println("public interface JGDIJMXMBean extends JGDIJMXBaseMBean {");
    p.print("");
...
} // end of class java_jmx_jgdi_jsp
