public class java_addevent_jsp implements com.sun.grid.cull.template.Template {
  public void print(final com.sun.grid.cull.Printer p, final java.util.Map params) {
    ...
    p.println("/**");
    p.println(" *  Generated from java_addevent.jsp");
...
p.println("");
    ...
    p.println("");
    p.println("import com.sun.grid.jgdi.event.AddEvent;");
    p.print("");
    ...
    p.print(name);p.println("AddEvent extends AddEvent implements java.io.Serializable {");
    p.println("");
    p.print("");
     // Default constructor ----------------------------------------- p.println("");
    p.print("  public ");
    p.print(name);p.println("AddEvent(long timestamp, int eventID) {");
...
} // end of class java_addevent_jsp
