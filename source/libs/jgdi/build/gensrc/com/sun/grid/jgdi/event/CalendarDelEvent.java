...
/**
 */
public class CalendarDelEvent extends DelEvent implements java.io.Serializable {

  public CalendarDelEvent(long timestamp, int eventID) {
     super(timestamp, eventID, Calendar.class );
  ...
  public Calendar get() {
     return (Calendar) getChangedObject();
  }
 ...
 */
  ...
  /**
   *   Set the primary key info of the Calendar.
   *
