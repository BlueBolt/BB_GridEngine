...
public class ManagerEventTestCase extends BaseTestCase {

   private JGDI jgdi;
   private EventClient evc;
   
   public ManagerEventTestCase(String name) {
      super(name);
   }
   
   public static Test suite() {
      TestSuite suite = new TestSuite(ManagerEventTestCase.class);
      return suite;
   }
   ...
   public void testManagerEvents() throws Exception {
      ...
      assertTrue("No test values for Manager", testValues.length > 0 );
      
      Manager testObj = (Manager)testValues[0];
      ...
      try {
          ...
          map.put(EventTypeEnum.ManagerAdd, flushInterval);
          map.put(EventTypeEnum.ManagerDel, flushInterval);
         ...
         assertTrue("Manager: Did not get the add event", waitThread.waitForAddEvent(timeout));
         ...
         assertTrue("Manager: Did not get the del event", waitThread.waitForDelEvent(timeout));
