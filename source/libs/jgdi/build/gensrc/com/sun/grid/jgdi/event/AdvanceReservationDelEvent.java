...
/**
 */
public class AdvanceReservationDelEvent extends DelEvent implements java.io.Serializable {

  public AdvanceReservationDelEvent(long timestamp, int eventID) {
  ...
  public void setPKInfo(int numKey1, int numKey2, String strKey1, String strKey2) {
   ...
   public boolean hasDeletedObject(Object obj) {
      ...
      if (obj instanceof  AdvanceReservation) {
          AdvanceReservation obj1 = (AdvanceReservation)obj;
