...
public class OperatorEventTestCase extends BaseTestCase {

   private JGDI jgdi;
   private EventClient evc;
   
   public OperatorEventTestCase(String name) {
      super(name);
   }
   
   public static Test suite() {
      TestSuite suite = new TestSuite(OperatorEventTestCase.class);
      return suite;
   }
   ...
   public void testOperatorEvents() throws Exception {
         
      Object [] testValues = TestValueFactory.getTestValues(Operator.class); 

      assertTrue("No test values for Operator", testValues.length > 0 );
      
      Operator testObj = (Operator)testValues[0];
      ...
      try {
          ...
          map.put(EventTypeEnum.OperatorAdd, flushInterval);
          map.put(EventTypeEnum.OperatorDel, flushInterval);
         ...
         assertTrue("Operator: Did not get the add event", waitThread.waitForAddEvent(timeout));
         ...
         assertTrue("Operator: Did not get the del event", waitThread.waitForDelEvent(timeout));
