 ...
 *
 *  <p><strong>Warning:</strong>  The  SubmitHostImpl class will 
 *  not be compatible with future Sun&trade; Grid Engine releases.</p>
 */
public class SubmitHostImpl extends    GEObjectImpl implements SubmitHost {


   /**
    *  Create a new instance of SubmitHostImpl. The new instance
    *  will not be initialized with the default values.
    */
   public SubmitHostImpl() {
      this(false);
   }
    ...
    */
   public SubmitHostImpl(boolean initWithDefaultValues) { 
  ...
  // --- newInstance method with primary key field
   ...
   /**
    *  Create a new instance of SubmitHostImpl
    */
   public SubmitHostImpl(java.lang.String name ) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof SubmitHostImpl && getName().equals(((com.sun.grid.jgdi.configuration.SubmitHost)obj).getName()));
    ...
    public boolean equalsCompletely(Object obj) {
        ...
        if (obj instanceof  SubmitHostImpl) {
            com.sun.grid.jgdi.configuration.SubmitHost obj1 = (com.sun.grid.jgdi.configuration.SubmitHost)obj;
            ...
            if (value1 == null) {
                if (value2 != null) {
                    if (logger.isLoggable(Level.FINE)) {
                        logger.fine("attribute SH_name of obj1 " + value2 + " is not null as obj " + value1);
                    }
                    return false;
                }
            } else {
                ...
                if (!value1.equals(value2)) {
                    if (logger.isLoggable(Level.FINE)) {
                        logger.fine("attributes SH_name are not equal: " + value1 + " != " + value2);
                    }
                    return false;
                }
