...
/**
 */
public class ResourceQuotaSetDelEvent extends DelEvent implements java.io.Serializable {

  public ResourceQuotaSetDelEvent(long timestamp, int eventID) {
     super(timestamp, eventID, ResourceQuotaSet.class );
  } // end of default constructor

  public void set(ResourceQuotaSet obj) {
     super.setChangedObject(obj);
  }
  
  public ResourceQuotaSet get() {
     return (ResourceQuotaSet) getChangedObject();
  }
 ...
 */
  ...
  /**
   *   Set the primary key info of the ResourceQuotaSet.
   *
  ...
  public void setPKInfo(int numKey1, int numKey2, String strKey1, String strKey2) {
   ...
   /**
    *   Get the name of the ResourceQuotaSet
    *
    *   @return the name of the ResourceQuotaSet
    */
   ...
   public boolean hasDeletedObject(Object obj) {
      ...
      if (obj instanceof  ResourceQuotaSet) {
          ResourceQuotaSet obj1 = (ResourceQuotaSet)obj;
