...
/**
 *  Java descriptor of the cull object HGRP_Type
 *  defined in sge_all_listsL.template
 */
public class HostgroupDescriptor extends  GEObjectDescriptor {

   public HostgroupDescriptor() {
      this(HostgroupImpl.class, "HGRP_Type" );
      setImplClass(HostgroupImpl.class);
   }
      
   protected HostgroupDescriptor(Class type, String name) {
      super(type, name);
     
      PropertyDescriptor propDescr = null;

      propDescr = addSimple("name", String.class, "SGE_HOST_D", CullConstants.HGRP_name, true, false, true); 

      propDescr = addList("host", String.class, "HR_Type", CullConstants.HGRP_host_list, true, false, true);
   ...
   public void validate(Object obj) throws InvalidObjectException {
      ...
      if (!(obj instanceof Hostgroup)) {
         throw new InvalidObjectException(obj, "obj is not an instanceof Hostgroup");
      }

      Hostgroup cullObj = (Hostgroup)obj;
