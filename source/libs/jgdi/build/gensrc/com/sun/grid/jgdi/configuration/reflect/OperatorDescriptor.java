...
/**
 *  Java descriptor of the cull object UO_Type
 *  defined in sge_all_listsL.template
 */
public class OperatorDescriptor extends  GEObjectDescriptor {

   public OperatorDescriptor() {
      this(OperatorImpl.class, "UO_Type" );
      setImplClass(OperatorImpl.class);
   }
      
   protected OperatorDescriptor(Class type, String name) {
      super(type, name);
     
      PropertyDescriptor propDescr = null;

      propDescr = addSimple("name", String.class, "SGE_STRING", CullConstants.UO_name, true, false, true); 
   ...
   public void validate(Object obj) throws InvalidObjectException {
      ...
      if (!(obj instanceof Operator)) {
         throw new InvalidObjectException(obj, "obj is not an instanceof Operator");
      }

      Operator cullObj = (Operator)obj;
