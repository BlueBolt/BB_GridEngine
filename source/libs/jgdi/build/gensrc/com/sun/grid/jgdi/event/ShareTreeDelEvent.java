...
/**
 */
public class ShareTreeDelEvent extends DelEvent implements java.io.Serializable {

  public ShareTreeDelEvent(long timestamp, int eventID) {
     super(timestamp, eventID, ShareTree.class );
  } // end of default constructor

  public void set(ShareTree obj) {
     super.setChangedObject(obj);
  }
  
  public ShareTree get() {
     return (ShareTree) getChangedObject();
  }
 ...
 */
  ...
  /**
   *   Set the primary key info of the ShareTree.
   *
  ...
  public void setPKInfo(int numKey1, int numKey2, String strKey1, String strKey2) {
   ...
   /**
    *   Get the name of the ShareTree
    *
    *   @return the name of the ShareTree
    */
