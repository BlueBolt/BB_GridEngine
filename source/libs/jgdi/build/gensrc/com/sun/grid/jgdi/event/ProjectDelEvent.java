...
/**
 */
public class ProjectDelEvent extends DelEvent implements java.io.Serializable {

  public ProjectDelEvent(long timestamp, int eventID) {
     super(timestamp, eventID, Project.class );
  ...
  public Project get() {
     return (Project) getChangedObject();
  }
