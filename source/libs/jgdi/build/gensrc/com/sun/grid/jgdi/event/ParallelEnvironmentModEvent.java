...
/**
 */
public class ParallelEnvironmentModEvent extends ModEvent implements java.io.Serializable {

  public ParallelEnvironmentModEvent(long timestamp, int eventID) {
     super(timestamp, eventID, ParallelEnvironment.class );
  ...
  public ParallelEnvironment get() {
     return (ParallelEnvironment) getChangedObject();
  }
 ...
 */
  ...
  public void setPKInfo(int numKey1, int numKey2, String strKey1, String strKey2) {
    ...
    *
    *   @return the name of the ParallelEnvironment
    */
