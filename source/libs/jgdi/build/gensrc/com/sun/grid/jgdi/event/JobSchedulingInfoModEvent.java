...
/**
 */
public class JobSchedulingInfoModEvent extends ModEvent implements java.io.Serializable {

  public JobSchedulingInfoModEvent(long timestamp, int eventID) {
  ...
  public JobSchedulingInfo get() {
     return (JobSchedulingInfo) getChangedObject();
  }
