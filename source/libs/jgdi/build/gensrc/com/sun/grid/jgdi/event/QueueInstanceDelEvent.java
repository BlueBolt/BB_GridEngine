...
/**
 */
public class QueueInstanceDelEvent extends DelEvent implements java.io.Serializable {

  public QueueInstanceDelEvent(long timestamp, int eventID) {
  ...
  public void setPKInfo(int numKey1, int numKey2, String strKey1, String strKey2) {
   ...
   public boolean hasDeletedObject(Object obj) {
      ...
      if (obj instanceof  QueueInstance) {
          QueueInstance obj1 = (QueueInstance)obj;
         // Attention: strkey must be set for cull event elem
         if (!m_fullName.equals(obj1.getFullName())) {
             return false;
         }
   ...
   public String toString() {
      ...
      ret.append(",");
      ret.append("QueueInstance");
      ret.append("(");
          ret.append(m_fullName);
