...
/**
 */
public class HostgroupDelEvent extends DelEvent implements java.io.Serializable {

  public HostgroupDelEvent(long timestamp, int eventID) {
     super(timestamp, eventID, Hostgroup.class );
  } // end of default constructor

  public void set(Hostgroup obj) {
     super.setChangedObject(obj);
  }
  
  public Hostgroup get() {
     return (Hostgroup) getChangedObject();
  }
 ...
 */
  ...
  /**
   *   Set the primary key info of the Hostgroup.
   *
  ...
  public void setPKInfo(int numKey1, int numKey2, String strKey1, String strKey2) {
   ...
   /**
    *   Get the name of the Hostgroup
    *
    *   @return the name of the Hostgroup
    */
