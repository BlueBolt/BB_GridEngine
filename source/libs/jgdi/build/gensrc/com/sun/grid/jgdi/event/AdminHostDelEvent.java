...
/**
 */
public class AdminHostDelEvent extends DelEvent implements java.io.Serializable {

  public AdminHostDelEvent(long timestamp, int eventID) {
     super(timestamp, eventID, AdminHost.class );
  } // end of default constructor

  public void set(AdminHost obj) {
     super.setChangedObject(obj);
  }
  
  public AdminHost get() {
     return (AdminHost) getChangedObject();
  }
 ...
 */
  ...
  /**
   *   Set the primary key info of the AdminHost.
   *
  ...
  public void setPKInfo(int numKey1, int numKey2, String strKey1, String strKey2) {
   ...
   /**
    *   Get the name of the AdminHost
    *
    *   @return the name of the AdminHost
    */
