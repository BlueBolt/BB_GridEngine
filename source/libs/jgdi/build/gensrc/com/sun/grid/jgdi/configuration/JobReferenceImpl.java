 ...
 *
 *  <p><strong>Warning:</strong>  The  JobReferenceImpl class will 
...
public class JobReferenceImpl extends    GEObjectImpl implements JobReference {
   ...
   /**
    *  Create a new instance of JobReferenceImpl. The new instance
  ...
  // --- newInstance method with primary key field
    ...
    */
   public JobReferenceImpl(int jobNumber ) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof JobReferenceImpl && getJobNumber() == ((com.sun.grid.jgdi.configuration.JobReference)obj).getJobNumber());
    ...
    public boolean equalsCompletely(Object obj) {
        ...
        if (obj instanceof  JobReferenceImpl) {
            com.sun.grid.jgdi.configuration.JobReference obj1 = (com.sun.grid.jgdi.configuration.JobReference)obj;
            ...
            if (value1 != value2) {
                if (logger.isLoggable(Level.FINE)) { 
                    logger.fine("primitive attributes JRE_job_number are not equal");
                }
                return false;
            }
            ...
            if (value1 == null) {
                if (value2 != null) {
                    if (logger.isLoggable(Level.FINE)) {
                        logger.fine("attribute JRE_job_name of obj1 " + value2 + " is not null as obj " + value1);
                    }
                    return false;
                }
            } else {
                ...
                if (!value1.equals(value2)) {
                    if (logger.isLoggable(Level.FINE)) {
                        logger.fine("attributes JRE_job_name are not equal: " + value1 + " != " + value2);
                    }
                    return false;
                }
