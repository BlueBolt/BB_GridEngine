...
/**
 */
public class ComplexEntryDelEvent extends DelEvent implements java.io.Serializable {

  public ComplexEntryDelEvent(long timestamp, int eventID) {
     super(timestamp, eventID, ComplexEntry.class );
  } // end of default constructor

  public void set(ComplexEntry obj) {
     super.setChangedObject(obj);
  }
  
  public ComplexEntry get() {
     return (ComplexEntry) getChangedObject();
  }
 ...
 */
  ...
  /**
   *   Set the primary key info of the ComplexEntry.
   *
  ...
  public void setPKInfo(int numKey1, int numKey2, String strKey1, String strKey2) {
   ...
   /**
    *   Get the name of the ComplexEntry
    *
    *   @return the name of the ComplexEntry
    */
   ...
   public boolean hasDeletedObject(Object obj) {
      ...
      if (obj instanceof  ComplexEntry) {
          ComplexEntry obj1 = (ComplexEntry)obj;
