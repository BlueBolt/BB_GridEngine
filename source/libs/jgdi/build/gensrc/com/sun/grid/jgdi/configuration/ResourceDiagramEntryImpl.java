...
/**
 *  Java representation of the cull object RDE_Type
 *  defined in sge_all_listsL.template
 *
 *  <p><strong>Warning:</strong>  The  ResourceDiagramEntryImpl class will 
...
public class ResourceDiagramEntryImpl extends    GEObjectImpl implements ResourceDiagramEntry {
   ...
   /**
    *  Create a new instance of ResourceDiagramEntryImpl. The new instance
  ...
  // --- newInstance method with primary key field
     ...
     *  @return <code>true</code> if the time attribute is set
     */
     ...
     *
     *   @param aTime  the new value for the  time attribute
     */
     ...
     *  @return <code>true</code> if the amount attribute is set
     */
     ...
     *
     *   @param aAmount  the new value for the  amount attribute
     */
    ...
    public boolean equals(Object obj) {
            ...
            return obj instanceof ResourceDiagramEntryImpl;
    ...
    public boolean equalsCompletely(Object obj) {
        ...
        if (obj instanceof  ResourceDiagramEntryImpl) {
            com.sun.grid.jgdi.configuration.ResourceDiagramEntry obj1 = (com.sun.grid.jgdi.configuration.ResourceDiagramEntry)obj;

            {
                int value1 = getTime();
                int value2 = obj1.getTime();        

            if (value1 != value2) {
                if (logger.isLoggable(Level.FINE)) { 
                    logger.fine("primitive attributes RDE_time are not equal");
                }
                return false;
            }
            ...
            {
                double value1 = getAmount();
                double value2 = obj1.getAmount();        

            if (value1 != value2) {
                if (logger.isLoggable(Level.FINE)) { 
                    logger.fine("primitive attributes RDE_amount are not equal");
                }
                return false;
            }
    ...
    public java.lang.String toString() {
        ...
        ret.append("ResourceDiagramEntryImpl(");
