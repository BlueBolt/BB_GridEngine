...
/**
 *  Java representation of the cull object ULNG_Type
 *  defined in sge_all_listsL.template
 *
 *  <p><strong>Warning:</strong>  The  ULNGImpl class will 
...
public class ULNGImpl extends    GEObjectImpl implements ULNG {
   ...
   /**
    *  Create a new instance of ULNGImpl. The new instance
  ...
  // --- newInstance method with primary key field
    ...
    public boolean equals(Object obj) {
            ...
            return obj instanceof ULNGImpl;
    ...
    public boolean equalsCompletely(Object obj) {
        ...
        if (obj instanceof  ULNGImpl) {
            com.sun.grid.jgdi.configuration.ULNG obj1 = (com.sun.grid.jgdi.configuration.ULNG)obj;

            {
                int value1 = getValue();
                int value2 = obj1.getValue();        

            if (value1 != value2) {
                if (logger.isLoggable(Level.FINE)) { 
                    logger.fine("primitive attributes ULNG_value are not equal");
                }
                return false;
            }
