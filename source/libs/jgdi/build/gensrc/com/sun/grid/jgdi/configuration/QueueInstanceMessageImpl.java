 ...
 *
 *  <p><strong>Warning:</strong>  The  QueueInstanceMessageImpl class will 
...
public class QueueInstanceMessageImpl extends    GEObjectImpl implements QueueInstanceMessage {
   ...
   /**
    *  Create a new instance of QueueInstanceMessageImpl. The new instance
  ...
  // --- newInstance method with primary key field
    ...
    public boolean equals(Object obj) {
            ...
            return obj instanceof QueueInstanceMessageImpl;
    ...
    public boolean equalsCompletely(Object obj) {
        ...
        if (obj instanceof  QueueInstanceMessageImpl) {
            com.sun.grid.jgdi.configuration.QueueInstanceMessage obj1 = (com.sun.grid.jgdi.configuration.QueueInstanceMessage)obj;
            ...
            if (value1 != value2) {
                if (logger.isLoggable(Level.FINE)) { 
                    logger.fine("primitive attributes QIM_type are not equal");
                }
                return false;
            }
            ...
            if (value1 == null) {
                if (value2 != null) {
                    if (logger.isLoggable(Level.FINE)) {
                        logger.fine("attribute QIM_message of obj1 " + value2 + " is not null as obj " + value1);
                    }
                    return false;
                }
            } else {
                ...
                if (!value1.equals(value2)) {
                    if (logger.isLoggable(Level.FINE)) {
                        logger.fine("attributes QIM_message are not equal: " + value1 + " != " + value2);
                    }
                    return false;
                }
    ...
    public java.lang.String toString() {
        ...
        ret.append("QueueInstanceMessageImpl(");
