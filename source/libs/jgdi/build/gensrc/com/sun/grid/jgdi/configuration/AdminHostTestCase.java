 ...
 *
 */
public class AdminHostTestCase extends BaseTestCase {
   
   public  AdminHostTestCase(java.lang.String testName) {
      super(testName);
   }
   
   public static Test suite() {
      TestSuite suite = new TestSuite(AdminHostTestCase.class);
      return suite;
   }
   

   public void testAdminHostListXML() throws Exception {
      JGDI jgdi = createJGDI();
      try {
         for (AdminHost obj : jgdi.getAdminHostList()) {
            File file = File.createTempFile("AdminHost", ".xml");
            try {
               XMLUtil.write(obj, file);
               AdminHost obj1 = (AdminHost)XMLUtil.read(file);
...
//                  logger.warning("org AdminHost is not equal to filed/reread obj1 AdminHost ------------------------"); 
...
// end debug: check differences
               ...
               assertTrue("serialized xml object of class AdminHost is invalid", 
