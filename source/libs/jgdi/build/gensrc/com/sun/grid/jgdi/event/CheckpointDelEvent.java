...
/**
 */
public class CheckpointDelEvent extends DelEvent implements java.io.Serializable {

  public CheckpointDelEvent(long timestamp, int eventID) {
     super(timestamp, eventID, Checkpoint.class );
  } // end of default constructor

  public void set(Checkpoint obj) {
     super.setChangedObject(obj);
  }
  
  public Checkpoint get() {
     return (Checkpoint) getChangedObject();
  }
 ...
 */
  ...
  /**
   *   Set the primary key info of the Checkpoint.
   *
  ...
  public void setPKInfo(int numKey1, int numKey2, String strKey1, String strKey2) {
   ...
   public boolean hasDeletedObject(Object obj) {
      ...
      if (obj instanceof  Checkpoint) {
          Checkpoint obj1 = (Checkpoint)obj;
