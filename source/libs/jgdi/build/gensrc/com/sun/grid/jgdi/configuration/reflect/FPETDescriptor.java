...
/**
 *  Java descriptor of the cull object FPET_Type
 *  defined in sge_all_listsL.template
 */
public class FPETDescriptor extends  GEObjectDescriptor {

   public FPETDescriptor() {
      this(FPETImpl.class, "FPET_Type" );
      setImplClass(FPETImpl.class);
   }
      
   protected FPETDescriptor(Class type, String name) {
      super(type, name);
     
      PropertyDescriptor propDescr = null;

      propDescr = addSimple("id", String.class, "SGE_STRING", CullConstants.FPET_id, true, false, false); 

   }
   
   public void validate(Object obj) throws InvalidObjectException {
   
      if (!(obj instanceof FPET)) {
         throw new InvalidObjectException(obj, "obj is not an instanceof FPET");
      }

      FPET cullObj = (FPET)obj;
