...
/**
 */
public class ExecHostDelEvent extends DelEvent implements java.io.Serializable {

  public ExecHostDelEvent(long timestamp, int eventID) {
     super(timestamp, eventID, ExecHost.class );
  } // end of default constructor

  public void set(ExecHost obj) {
     super.setChangedObject(obj);
  }
  
  public ExecHost get() {
     return (ExecHost) getChangedObject();
  }
 ...
 */
  ...
  /**
   *   Set the primary key info of the ExecHost.
   *
  ...
  public void setPKInfo(int numKey1, int numKey2, String strKey1, String strKey2) {
   ...
   /**
    *   Get the name of the ExecHost
    *
    *   @return the name of the ExecHost
    */
