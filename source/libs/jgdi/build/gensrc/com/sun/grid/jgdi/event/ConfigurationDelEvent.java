...
/**
 */
public class ConfigurationDelEvent extends DelEvent implements java.io.Serializable {

  public ConfigurationDelEvent(long timestamp, int eventID) {
     super(timestamp, eventID, Configuration.class );
  } // end of default constructor

  public void set(Configuration obj) {
     super.setChangedObject(obj);
  }
  
  public Configuration get() {
     return (Configuration) getChangedObject();
  }
 ...
 */
  ...
  /**
   *   Set the primary key info of the Configuration.
   *
  ...
  public void setPKInfo(int numKey1, int numKey2, String strKey1, String strKey2) {
   ...
   public boolean hasDeletedObject(Object obj) {
      ...
      if (obj instanceof  Configuration) {
          Configuration obj1 = (Configuration)obj;
