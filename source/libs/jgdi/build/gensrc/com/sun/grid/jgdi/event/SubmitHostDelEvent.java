...
/**
 */
public class SubmitHostDelEvent extends DelEvent implements java.io.Serializable {

  public SubmitHostDelEvent(long timestamp, int eventID) {
  ...
  public void setPKInfo(int numKey1, int numKey2, String strKey1, String strKey2) {
   ...
   public boolean hasDeletedObject(Object obj) {
      ...
      if (obj instanceof  SubmitHost) {
          SubmitHost obj1 = (SubmitHost)obj;
