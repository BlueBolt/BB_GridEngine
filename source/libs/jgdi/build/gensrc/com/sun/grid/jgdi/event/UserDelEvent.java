...
/**
 */
public class UserDelEvent extends DelEvent implements java.io.Serializable {

  public UserDelEvent(long timestamp, int eventID) {
     super(timestamp, eventID, User.class );
 ...
 */
  ...
  /**
   *   Set the primary key info of the User.
   *
