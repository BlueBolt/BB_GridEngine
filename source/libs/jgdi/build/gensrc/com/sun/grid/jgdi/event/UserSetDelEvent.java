...
/**
 */
public class UserSetDelEvent extends DelEvent implements java.io.Serializable {

  public UserSetDelEvent(long timestamp, int eventID) {
     super(timestamp, eventID, UserSet.class );
  } // end of default constructor

  public void set(UserSet obj) {
     super.setChangedObject(obj);
  }
  
  public UserSet get() {
     return (UserSet) getChangedObject();
  }
 ...
 */
  ...
  /**
   *   Set the primary key info of the UserSet.
   *
  ...
  public void setPKInfo(int numKey1, int numKey2, String strKey1, String strKey2) {
   ...
   /**
    *   Get the name of the UserSet
    *
    *   @return the name of the UserSet
    */
